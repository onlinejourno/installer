...
const PRODUCTS = {
  newsroom: {
    ...
    optionalEnv: ["ANTHROPIC_API_KEY", "OPENAI_API_KEY", "OPENAI_BASE_URL", "KEYWORDS_EVERYWHERE_API_KEY", "DATAFORSEO_LOGIN", "DATAFORSEO_PASSWORD"],
    needsAdmin: true,
  },
  daybook: {
    name: "Daybook",
  ...
  if (product.slug === "newsroom") {
    return (
      ...
      [
        ...
        "# The newsroom supports multiple keyword/SEO providers. Leave unused ones blank.",
